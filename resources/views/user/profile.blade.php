...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Please Complete Profile') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('profile') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <label for="fresher" class="col-md-4 col-form-label text-md-right">{{ __('Fresher') }}</label>
                                <input id="fresher" type="radio" class="@error('fresher') is-invalid @enderror" name="experience" value="0" required autocomplete="fresher" autofocus>
                                ...
                                <input id="experience" type="radio" class="@error('experience') is-invalid @enderror" name="experience" value="1" required autocomplete="experience" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="experience_detail" class="col-md-4 col-form-label text-md-right">{{ __('Experience Details') }}</label>

                            <div class="col-md-6">
                                <input id="experience_detail" type="text" class="form-control @error('experience_detail') is-invalid @enderror" name="experience_detail" value="{{ old('experience_detail') }}" required autocomplete="experience_detail" autofocus>
